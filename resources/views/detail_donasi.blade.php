<header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#F4F4F4] px-10 py-3 shadow-md ">
    ...
    <div class="flex flex-1 justify-end gap-8">
        <div class="flex items-center gap-9">
            ...
            <a class="text-[#141414] text-lg font-medium leading-normal" href="{{ route('donasi.transaksi') }}">Data
                Donasi</a>
        </div>
        @auth
            <button
